    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid md:grid-cols-2 gap-8 md:gap-16 items-center about-section">
        ...
        <div>
          ...
          >
            <div class="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center group-hover:bg-primary-200 transition-colors">
              <Icon icon="mdi:file-account-outline" class="w-4 h-4 text-primary-600" />
            </div>
            Download Resume
            <Icon icon="mdi:download" class="w-4 h-4 text-text-muted group-hover:text-primary-600 transition-colors ml-auto" />
          </a>
        </div>
        ...
        <div class="flex flex-col items-center gap-5">
          ...
          <transition name="bubble">
            <div v-if="revealed" class="relative w-full max-w-[260px]">
              ...
              <div class="absolute -bottom-[9px] left-1/2 -translate-x-1/2 w-0 h-0 border-x-[9px] border-x-transparent border-t-[9px] border-t-border"></div>
              <div class="absolute -bottom-[7px] left-1/2 -translate-x-1/2 w-0 h-0 border-x-[8px] border-x-transparent border-t-[8px] border-t-white"></div>
            </div>
          </transition>
...
.bubble-leave-active { transition: all 0.18s ease; }
.bubble-enter-from   { opacity: 0; transform: scale(0.82) translateY(8px); }
.bubble-leave-to     { opacity: 0; transform: scale(0.92); }
</style>
